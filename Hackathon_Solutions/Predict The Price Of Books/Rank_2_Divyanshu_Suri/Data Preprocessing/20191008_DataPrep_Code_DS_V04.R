...
write.csv(training01,"C:\\Kaggle\\BooksPrice\\Participants_Data\\Data_Train04.csv",row.names = FALSE)
write.csv(testing01,"C:\\Kaggle\\BooksPrice\\Participants_Data\\Data_Test04.csv",row.names = FALSE)