...
write.csv(training01,"C:\\Kaggle\\BooksPrice\\Participants_Data\\Data_Train06.csv",row.names = FALSE)
write.csv(testing01,"C:\\Kaggle\\BooksPrice\\Participants_Data\\Data_Test06.csv",row.names = FALSE)