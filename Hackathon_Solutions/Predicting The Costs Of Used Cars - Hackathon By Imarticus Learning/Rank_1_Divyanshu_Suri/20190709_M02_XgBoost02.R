...
#FINAL RMSE :  0.1561091
#LB SCORE : 0.9319 , 0.0681
1 - 0.9319
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190709_XGB02_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190709_XGB02_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190709_XGB02_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
