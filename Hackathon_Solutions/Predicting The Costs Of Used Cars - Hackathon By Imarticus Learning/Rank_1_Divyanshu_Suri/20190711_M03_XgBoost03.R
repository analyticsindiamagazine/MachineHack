...
for (i in 1:num_folds)
{
  ...
  XGB_mod_1 <- xgb.train(   params = param,
                            ...
                            print.every.n = 25
  )#[11930]	train-rmse:0.053684	val-rmse:0.143946
...
#FINAL RMSE :  0.1527279
#LB SCORE : 0.9359 , 0.0641
1 - 0.9359
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190711_XGB03_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190711_XGB03_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190711_XGB03_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
