...
#FINAL RMSE :  0.2410145  ; size, iter :  1 ,  2000
preds_sub <- preds_sub / num_folds
summary(preds_sub)
...
#FINAL RSQUARE :  0.1943476  ; mtry, ntree, sampsize, nodesize :  5 ,  50 ,  0.8 ,  5
preds_sub <- preds_sub / num_folds
summary(preds_sub)
...
#FINAL RMSE :  0.1963368  ; numTrees, IntDepth, MinObs, BagFrac, best.iter :  500 ,  6 ,  5 ,  0.9 ,  237
preds_sub <- preds_sub / num_folds
summary(preds_sub)
...
feature.names2 <- c("pred_XGB_Final","pred_KNN_Final","pred_ANN_Final","pred_RF_Final","pred_GBM_Final","pred_LM_Final",
...
for (i in 1:num_folds)
{
  ...
  #[3022]	train-rmse:0.141315	val-rmse:0.146299
...
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190715_StackModel02_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
