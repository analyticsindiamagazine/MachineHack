...
#FINAL RMSE :  0.1192888
#LB SCORE : 0.9247 , 0.0753
1 - 0.9247
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190715_XGB05_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190715_XGB05_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190715_XGB05_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
