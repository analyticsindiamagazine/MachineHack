...
#FINAL RMSE :  0.1595644
#LB SCORE : 0.9389 , 0.0611
1 - 0.9389
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190715_XGB06_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190715_XGB06_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190715_XGB06_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
