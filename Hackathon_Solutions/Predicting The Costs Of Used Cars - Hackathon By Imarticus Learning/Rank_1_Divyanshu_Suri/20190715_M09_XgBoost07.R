...
for (i in 1:num_folds)
{
  ...
  XGB_mod_1 <- xgb.train(   params = param,
                            ...
                            print.every.n = 25
  )#[3458]	train-rmse:0.039080	val-rmse:0.150606
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190715_XGB07_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190715_XGB07_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190715_XGB07_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
