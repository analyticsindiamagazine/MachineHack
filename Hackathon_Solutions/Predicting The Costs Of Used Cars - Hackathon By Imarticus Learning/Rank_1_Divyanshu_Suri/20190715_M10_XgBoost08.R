...
for (i in 1:num_folds)
{
  ...
  XGB_mod_1 <- xgb.train(   params = param,
                            ...
                            print.every.n = 25
  )#[2065]	train-rmse:0.064001	val-rmse:0.141766
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190715_XGB08_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190715_XGB08_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190715_XGB08_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
