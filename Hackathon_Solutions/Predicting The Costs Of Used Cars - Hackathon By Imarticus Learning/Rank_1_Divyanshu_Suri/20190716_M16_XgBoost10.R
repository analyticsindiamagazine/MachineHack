...
write.csv(train02, "C:\\Kaggle\\Cars\\Data\\TrnDataForLGB.csv", row.names = FALSE)
write.csv(test02, "C:\\Kaggle\\Cars\\Data\\TstDataForLGB.csv", row.names = FALSE)
...
for (i in 1:num_folds)
{
  ...
  XGB_mod_1 <- xgb.train(   params = param,
                            ...
                            print.every.n = 25
  )#[1818]	train-rmse:0.052424	val-rmse:0.136131
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190716_XGB10_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190716_XGB10_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190716_XGB10_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
