...
feature.names <- names(combined05)[!(names(combined05) %in% c("id","Price","New_Price","Name","Lag_Price2_MIN","Lag_Price2_MAX",
                                                              ...
                                                              "Lag_Price4_MIN","Lag_Price4_MAX","Lag_Price4_MIN_BY_MAX","Location",
                                                              "Lag_Price5","Lag_Price6","P_New_Price"))]
...
train02$Price <- (train02$Price)**0.1
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190718_XGB12_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190718_XGB12_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_XGB_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190718_XGB12_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)
