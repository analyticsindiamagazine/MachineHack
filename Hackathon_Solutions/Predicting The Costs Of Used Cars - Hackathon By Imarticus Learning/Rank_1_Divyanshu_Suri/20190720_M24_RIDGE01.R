...
#FINAL RMSE :  0.07988463  ; lambda :  0.0031
#LB SCORE : 0.9298
...
write_csv(test02, "C:\\Kaggle\\Cars\\Test_Scored\\20190721_RIDGE01_TEST_DS.csv")
write_csv(cv_testData, "C:\\Kaggle\\Cars\\CV_Scored\\20190721_RIDGE01_CVTRAIN_DS.csv")

sub <- data.frame(Price = test02$pred_Final)
write.xlsx(sub, "C:\\Kaggle\\Cars\\Submission\\20190721_RIDGE01_TEST_DS.xlsx", colNames = TRUE, rowNames = FALSE)